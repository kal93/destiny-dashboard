...
export interface ICardDefinition {
    definitionId: number;  //Unique ID of the card
...
export class CardDefinitions {
    ...
    static defaultDashboards: Array<IUserDashboard> = [{
        id: -1, name: "Default Dashboard", cards: [
            { id: 3, sequence: 2, definitionId: 1, layoutId: 1, definition: CardDefinitions.definitions[1], layout: CardDefinitions.definitions[1].layouts[1] },
            ...
            { id: 1, sequence: 1, definitionId: 0, layoutId: 0, definition: CardDefinitions.definitions[0], layout: CardDefinitions.definitions[0].layouts[0] },
            { id: 4, sequence: 4, definitionId: 3, layoutId: 2, definition: CardDefinitions.definitions[3], layout: CardDefinitions.definitions[3].layouts[2] }
        ]
    }, {
