...
export class CardDefinitions {
    ...
    static defaultDashboards: Array<IUserDashboard> = [{
        id: -1, name: "Default Dashboard", cards: [
            ...
            { id: -4, sequence: 3, definitionId: 7, layoutId: 3, definition: CardDefinitions.definitions[7], layout: CardDefinitions.definitions[7].layouts[3] },
            { id: -5, sequence: 4, definitionId: 9, layoutId: 3, definition: CardDefinitions.definitions[9], layout: CardDefinitions.definitions[9].layouts[3] }
        ]
    }, {
