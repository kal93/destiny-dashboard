...
import { INews } from './bungie-news.interface';
...
export class BungieNewsService {
    ...
    getBungieNews(page: number): Promise<INews> {
        var requestUrl = "https://www.bungie.net/d1/Platform/Content/Site/News/" + NewsTypes.ALL + "/" + this.sharedApp.languageKey + "/?currentpage=" + page + "&itemsperpage=10";
