...
import { IVaultSummary } from './vault-summary.interface';
...
export class VaultSummaryService {
    ...
    getVaultSummary(membership: DestinyMembership): Promise<IVaultSummary> {
        ...
        var requestUrl = "https://www.bungie.net/d1/Platform/Destiny/" + membership.membershipType + "/MyAccount/Vault/Summary/";
